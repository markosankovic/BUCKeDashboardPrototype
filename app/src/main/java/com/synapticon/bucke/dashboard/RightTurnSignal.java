...
public class RightTurnSignal extends View {
    ...
    public RightTurnSignal(Context context) {
        super(context);
        init();
    }

    public RightTurnSignal(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RightTurnSignal(Context context, AttributeSet attrs, int defStyle) {
